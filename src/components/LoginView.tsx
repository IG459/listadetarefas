...
export const LoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-950 text-slate-100 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-950 via-slate-900 to-slate-950 p-12 flex-col justify-between relative overflow-hidden border-r border-slate-800/50">
        {/* Glow Effects */}
        ...
        <div className="my-auto max-w-lg z-10">
          ...
          <div className="mb-8 p-6 bg-slate-900/60 backdrop-blur-md rounded-2xl border border-slate-850 shadow-2xl relative">
